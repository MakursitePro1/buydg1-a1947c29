...
const testimonials = [
  { name: "রাফি আহমেদ", role: "গ্রাফিক ডিজাইনার", text: "Banglafeel আমার ডেইলি ওয়ার্কফ্লো সম্পূর্ণ বদলে দিয়েছে। এত সহজ এবং দ্রুত টুলস আর কোথাও পাইনি!", stars: 5 },
  ...
  { name: "নাদিয়া করিম", role: "ইউটিউবার", text: "থাম্বনেইল বানানো থেকে শুরু করে ফটো এডিট — সবকিছুই করি Banglafeel দিয়ে। অসাধারণ!", stars: 5 },
    ...
    <div className="container mx-auto px-4">
      ...
      >
        ...
        <h2 className="mb-3 font-display text-3xl font-bold text-foreground md:text-4xl">
          সবাই <span className="gradient-text">ভালোবাসে</span> Banglafeel
        </h2>
      </motion.div>
